Feature: Account registry
    ...
    Scenario: User is able to create a second account
        ...
        When I create an account using name: "Bob", last name: "Example", pesel: "97111883785"
        Then Number of accounts in registry equals: "2"
        And Account with pesel "97111883785" exists in registry
    ...
    Scenario: User is able to update surname of already created account
        Given Account with pesel "97111883785" exists in registry
        When I update "surname" of account with pesel: "97111883785" to "Johnson"
        Then Account with pesel "97111883785" has "surname" equal to "Johnson"
    ...
    Scenario: User is able to delete last account
        Given Account with pesel "97111883785" exists in registry
        When I delete account with pesel: "97111883785"
        Then Account with pesel "97111883785" does not exist in registry
